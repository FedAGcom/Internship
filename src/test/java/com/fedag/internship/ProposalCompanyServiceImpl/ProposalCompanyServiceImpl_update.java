...
public class ProposalCompanyServiceImpl_update {
    @InjectMocks
    ...
    public void testCompanyNotFound() {
        ...
        try {
            proposalCompanyService.update(id, company);
    ...
    public void testPositive() {
        ...
        ProposalCompanyEntity result = proposalCompanyService.update(id, newCompany);
